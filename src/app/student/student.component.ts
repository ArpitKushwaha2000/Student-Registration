...
export class StudentComponent {
  ...
  register()
  {
    ...
    this.http.post("http://localhost:8085/api/v1/student/save",bodyData,{responseType: 'text'}).subscribe((resultData: any)=>
    {
  ...
  setDelete(data: any)
  {
    ...
    this.http.delete("http://localhost:8085/api/v1/student/delete"+ "/"+ data._id,{responseType: 'text'}).subscribe((resultData: any)=>
    {
        console.log(resultData);
